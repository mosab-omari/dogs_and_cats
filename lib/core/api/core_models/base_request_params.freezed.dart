...
part of 'base_request_params.dart';
...
/// @nodoc
mixin _$BaseRequestParams<Model> {
  String get url => throw _privateConstructorUsedError;
  Model Function(List<dynamic>)? get converter =>
      throw _privateConstructorUsedError;
  ApiMethod get apiMethod => throw _privateConstructorUsedError;
  GeneralRequestModel? get data => throw _privateConstructorUsedError;
  String? get apiKey => throw _privateConstructorUsedError;
  GeneralRequestModel? get queryParameters =>
      throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $BaseRequestParamsCopyWith<Model, BaseRequestParams<Model>> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BaseRequestParamsCopyWith<Model, $Res> {
  factory $BaseRequestParamsCopyWith(BaseRequestParams<Model> value,
          $Res Function(BaseRequestParams<Model>) then) =
      _$BaseRequestParamsCopyWithImpl<Model, $Res, BaseRequestParams<Model>>;
  @useResult
  $Res call(
      {String url,
...
/// @nodoc
class _$BaseRequestParamsCopyWithImpl<Model, $Res,
        $Val extends BaseRequestParams<Model>>
    implements $BaseRequestParamsCopyWith<Model, $Res> {
  _$BaseRequestParamsCopyWithImpl(this._value, this._then);
...
class __$$BaseRequestParamsImplCopyWithImpl<Model, $Res>
    extends _$BaseRequestParamsCopyWithImpl<Model, $Res,
...
class _$BaseRequestParamsImpl<Model> extends _BaseRequestParams<Model> {
  ...
  @override
  final GeneralRequestModel? data;
  @override
  final String? apiKey;
  @override
  final GeneralRequestModel? queryParameters;
  @override
  @JsonKey()
  ...
  @override
  String toString() {
    return 'BaseRequestParams<$Model>(url: $url, converter: $converter, apiMethod: $apiMethod, data: $data, apiKey: $apiKey, queryParameters: $queryParameters, withAuthentication: $withAuthentication, withCaching: $withCaching, uploadNotification: $uploadNotification, downloadNotification: $downloadNotification, withFiles: $withFiles)';
  }
...
abstract class _BaseRequestParams<Model> extends BaseRequestParams<Model> {
